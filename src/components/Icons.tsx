...
export function WhatsAppIcon({ className }: IconProps) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M5.35 18.65 6.2 15.5a7.05 7.05 0 1 1 2.38 2.32l-3.23.83Z"
        stroke="currentColor"
        strokeWidth="1.45"
        strokeLinecap="round"
